...
export const metadata: Metadata = {
  ...
  description:
    'Дополнительная образовательная программа спортивной подготовки по виду спорта «Дзюдо» ДЮСШ клуба дзюдо «Локомотив» (КБР). Этапы, объёмы, учебно-тренировочный план, воспитательная работа, антидопинг и восстановление.',
}

const PDF_HREF = '/programma-sportivnoy-podgotovki-2026.pdf'
...
/* Содержание для быстрой навигации по длинному документу */
const toc = [
    ...
    <>
      ...
      <div className="relative overflow-hidden border-b border-line bg-ink-800 bg-tatami">
        <Container className="py-16 lg:py-24">
          ...
          <h1 className="mt-3 max-w-4xl text-4xl font-bold uppercase text-paper sm:text-5xl lg:text-6xl">
          ...
          <p className="mt-5 max-w-3xl text-lg text-muted">
            ...
            Разработана на основе Федерального стандарта спортивной подготовки, утверждённого приказом
            Министерства спорта России от 14.08.2025 г. № 655.
          </p>

          {/* Кнопка скачивания — на видном месте */}
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={m.k} className="rounded-xl border border-line bg-surface/50 p-4">
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            {[
              ...
              },
              {
                ...
                items: [
                  {
                    sub: '2.1. Формирование здорового образа жизни',
                    text: 'Дни здоровья и спорта: формирование знаний и умений в проведении дней здоровья и спорта, спортивных фестивалей; написание положений и требований, проведение мероприятий, ведение протоколов, подготовка пропагандистских акций по формированию здорового образа жизни.',
                  },
                  {
                    sub: '2.2. Режим питания и отдыха',
                    text: 'Практическая деятельность и восстановительные процессы обучающихся, формирование навыков правильного режима дня с учётом спортивного режима.',
                  },
                ],
              },
              {
                ...
                items: [
                  {
                    sub: '3.1. Теоретическая подготовка',
                    text: 'Воспитание патриотизма, гордости за свой край и Родину, уважения к гербу, флагу, гимну, готовности к служению Родине; традиции и развитие дзюдо, легендарные спортсмены, поведение болельщиков. Беседы, встречи, диспуты с привлечением именитых спортсменов, тренеров и ветеранов спорта.',
                  },
                  {
                    sub: '3.2. Практическая подготовка',
                    text: 'Участие в физкультурных и спортивно-массовых мероприятиях, спортивных соревнованиях, в том числе в парадах, церемониях открытия и закрытия, награждения, тематических мероприятиях и праздниках.',
                  },
                ],
              },
              {
              ...
              <Reveal key={g.n} delay={(i % 2) * 0.06}>
                <div className="flex h-full flex-col rounded-2xl border border-line bg-surface/50 p-6">
                  <div className="flex items-center gap-3">
                    <span className="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-accent font-display text-lg font-bold text-white">
                      {g.n}
                    </span>
                  ...
                  <div className="mt-4 border-t border-line pt-3 text-xs uppercase tracking-wide text-muted">
        ...
        <Container>
          ...
          <div className="grid gap-5 lg:grid-cols-3">
            {[
              {
                stage: 'ЭНП',
                full: 'Этап начальной подготовки',
                text: 'Антидопинговые правила, ответственность за нарушение. Права и обязанности спортсменов, принцип строгой отчётности, виды нарушений, применение лекарственных средств, проверка препаратов, риски использования пищевых добавок.',
                months: ['Октябрь', 'Апрель'],
              },
              {
                stage: 'УТЭ',
                full: 'Учебно-тренировочный этап',
                text: 'Виды нарушений антидопинговых правил и ответственность за них. Принципы и ценности чистого спорта. Глобальная антидопинговая система. Субстанции и методы из запрещённого списка, применение лекарственных средств. Средства и разрешение на ТИ.',
                months: ['Ноябрь', 'Декабрь', 'Январь', 'Февраль', 'Апрель'],
              },
              {
                stage: 'ЭССМ / ЭВСМ',
                full: 'Совершенствование и высшее мастерство',
                text: 'Виды нарушений антидопинговых правил и ответственность за них. Последствия применения допинга для физического и психического здоровья, социальные и экономические последствия, санкции. Как сообщить о допинге, обработка результатов.',
                months: ['Октябрь', 'Декабрь', 'Март'],
              },
            ].map((c, i) => (
              <Reveal key={c.stage} delay={i * 0.06}>
                <div className="flex h-full flex-col rounded-2xl border border-line bg-ink p-6">
                  ...
                  <div className="mt-4 flex flex-wrap gap-1.5 border-t border-line pt-4">
                    {c.months.map((m) => (
                      <span key={m} className="rounded-md border border-line bg-surface/60 px-2.5 py-1 text-xs font-medium text-paper/80">
                        {m}
                      </span>
                    ))}
                  </div>
            ...
            <div className="flex flex-col items-start justify-between gap-6 rounded-2xl border border-primary-400/30 bg-primary/10 p-8 sm:flex-row sm:items-center">
              <div>
                ...
                <p className="mt-2 max-w-xl text-sm text-muted">
                  На странице приведена дополнительная образовательная программа спортивной подготовки.
                  Официальный документ со всеми приложениями доступен для скачивания.
                </p>
              </div>
              <a
                href={PDF_HREF}
